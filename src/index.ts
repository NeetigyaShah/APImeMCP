...
import { ensureStorageInitialized, findTemplateById, findTemplateByUrl, loadManifest, registerTemplate, loadRecording, listRecordings, saveRecording } from './storage.js';
...
import { addFromRegistry, fetchRegistryManifest, submitTemplatePR } from './registry-client.js';
